...
- Final candidate `ed870aadbcfb796c18039f267d2eeedc64f3872b` / plugin rc.3 passed all four real archive checks and native smoke. Final actual harness: 5/5 timed useful sourced responses (30.939/26.187/27.233/24.901/29.250s) across4layouts; installation-to-first31.950s; all7extra cases including unassisted serial passed. No source/index mutations or script/hook execution across12runs. Earlier rc.2 serial and initial archive-layout failures remain recorded. Full results and setup limitations: evaluation/stage-5-results.md; artifacts: docs/candidate.md.
